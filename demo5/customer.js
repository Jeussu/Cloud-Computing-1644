...
var url = 'mongodb+srv://vinhdtasm2cloud:vinh1245@cluster0-no7z4.mongodb.net/test/';
...
router.post('/doInsert',async (req,res)=>{
    ...
    let phonevalue = req.body.Quantity;
    let addressValue = req.body.txtAddress;
    let newCustomer = {name : nameValue, address:addressValue, Quantity:phonevalue};
